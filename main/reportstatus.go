...
func reportStatus(ctx logging.ExtensionLogger, hEnv handlerenv.HandlerEnvironment, seqNum int, t StatusType, c cmd, msg string) error {
...
func reportStatusWithSubstatuses(ctx logging.ExtensionLogger, hEnv handlerenv.HandlerEnvironment, seqNum int, t StatusType, op string, msg string, substatuses []SubstatusItem) error {
