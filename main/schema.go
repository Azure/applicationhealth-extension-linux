...
const (
    ...
    "properties": {
      ...
      "numberOfProbes": {
        "description": "Optional - The number of probe reponses needed to change health state",
        "type": "integer",
        "default": 1,
        "minimum": 1,
        "maximum": 24
