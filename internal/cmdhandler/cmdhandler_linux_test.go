...
func Test_extCommands(t *testing.T) {
	...
	installCmd, ok := commands[Install]
	...
	uninstallCmd, ok := commands[Uninstall]
	...
	disableCmd, ok := commands[Disable]
